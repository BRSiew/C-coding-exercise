...
namespace ProductAppsTest
{
    ...
    public class UnitTest1
    {
        ...
        {
            driver.Url = "http://localhost:64410/";

            driver.Navigate().GoToUrl("http://localhost:64410/Product/Create");

            driver.Manage().Window.Maximize();
            // IWebElement ap = driver.FindElement(By.Id("learn"));
            IWebElement FeedCreate = driver.FindElement(By.XPath("/html/body/div[2]/p/a"));
            string text = FeedCreate.Text;
            //String title = driver.Titles;

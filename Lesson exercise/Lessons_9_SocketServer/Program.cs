...
namespace Lessons_9_SocketServer
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //Accept is a synchrouous method (Blocking method) will not move forward until operation is completed -- very bad method
                ...
                // define a buffer as a byte array of 128 byte length.
